...
export default function Home() {
  ...
  const github_url = "https://github.com/cyanfx"
    ...
    <div>
      ...
      <div className="flex items-center justify-center h-screen bg-warmGray-900">
        <main>
          <h1
            className={
              " select-none text-center mb-9 text-8xl sm:text-9xl md:text-12xlc tracking-wider -mt-20 " +
          ...
          <div className="flex flex-row justify-center space-x-8">
            ...
            <a target="_blank" href={github_url}>
              <svg
                className="h-8 text-gray-300 duration-100 transform fill-current sm:h-11 hover:text-gray-400 hover:scale-110"
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 24 24">
            ...
            <div id={"divButton"} className={"relative"} tabIndex="0">
              ...
              <div
                id={"copiedText"}
                className={
                  "opacity-0 transition-opacity ease-out font-light text-gray-400 absolute left-12 top-2 text-xs sm:left-16 sm:top-2.5 sm:text-base"
                }>
                Copied!
              </div>
              <button
                ...
                <svg
                  className={
                    "h-8 sm:h-11 fill-current duration-100 text-gray-300 hover:text-indigo-400 transform hover:scale-110"
                  }
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 24 24">
